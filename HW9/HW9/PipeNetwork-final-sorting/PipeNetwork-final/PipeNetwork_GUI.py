...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.tree_Nodes.headerItem().setFont(1, font)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.tree_Nodes.headerItem().setFont(2, font)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.tree_Nodes.headerItem().setFont(3, font)
        self.verticalLayout_2.addWidget(self.tree_Nodes)
        self.gridLayout.addLayout(self.verticalLayout_2, 2, 2, 8, 1)
        ...
        self.grid_Feedback.addWidget(self.btn_Evaluate, 0, 0, 1, 1, QtCore.Qt.AlignTop)
