...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.main_VerticalLayout.addItem(spacerItem5)
        ...
        self.cmb_Xaxis = QtWidgets.QComboBox(self.gb_Plot)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cmb_Xaxis.sizePolicy().hasHeightForWidth())
        self.cmb_Xaxis.setSizePolicy(sizePolicy)
        self.cmb_Xaxis.setMaximumSize(QtCore.QSize(50, 16777215))
        self.cmb_Xaxis.setObjectName("cmb_Xaxis")
        self.cmb_Xaxis.addItem("")
        self.cmb_Xaxis.addItem("")
        self.cmb_Xaxis.addItem("")
        self.cmb_Xaxis.addItem("")
        self.grid_Plot.addWidget(self.cmb_Xaxis, 0, 1, 1, 1)
        self.cmb_Yaxis = QtWidgets.QComboBox(self.gb_Plot)
        self.cmb_Yaxis.setMaximumSize(QtCore.QSize(50, 16777215))
        self.cmb_Yaxis.setObjectName("cmb_Yaxis")
        self.cmb_Yaxis.addItem("")
        self.cmb_Yaxis.addItem("")
        self.cmb_Yaxis.addItem("")
        self.cmb_Yaxis.addItem("")
        self.grid_Plot.addWidget(self.cmb_Yaxis, 0, 3, 1, 1)
        ...
        self.grid_Plot.addItem(spacerItem6, 0, 4, 1, 1)
        self.main_VerticalLayout.addWidget(self.gb_Plot)

        self.retranslateUi(Form)
        self.cmb_Xaxis.setCurrentIndex(0)
        self.cmb_Yaxis.setCurrentIndex(0)
    ...
    def retranslateUi(self, Form):
        ...
        self.cmb_Xaxis.setItemText(0, _translate("Form", "v"))
        self.cmb_Xaxis.setItemText(1, _translate("Form", "P"))
        self.cmb_Xaxis.setItemText(2, _translate("Form", "T"))
        self.cmb_Xaxis.setItemText(3, _translate("Form", "s"))
        self.cmb_Yaxis.setItemText(0, _translate("Form", "P"))
        self.cmb_Yaxis.setItemText(1, _translate("Form", "v"))
        self.cmb_Yaxis.setItemText(2, _translate("Form", "T"))
        self.cmb_Yaxis.setItemText(3, _translate("Form", "s"))
